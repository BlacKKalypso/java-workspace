package com.crea.bdwa1.backend.common;
...
public class Saisie {
	...
	public static String lireChaine(String message){
	 ...
	 public static int[ ] lireTabInt() {
		int [ ] tabDeInt = null;
		int numberChiffre = Saisie.lireEntier("Combien d'entier voulez vous ajouter ? :");
		tabDeInt = new int[numberChiffre];

		for (int i=0 ; i< numberChiffre; i++){
